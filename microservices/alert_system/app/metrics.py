"""
Prometheus configuration for the Alert System microservice.
"""
...
# Custom metric for Alert System: Messages processed
messages_processed_total = Counter(
    "messages_processed_total",
    "Total number of Kafka messages processed by alert_system",
    ["service", "node", "status"]
)

def track_requests(func):
    """
    A decorator to track HTTP request metrics.
    """
    @wraps(func)
...
def track_message_processed(success: bool):
    """
    Track Kafka message processing results.
    """
